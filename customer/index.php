...
.hero-info-text p  { font-size:10px; color:#666; margin-bottom:1px; }
.hero-info-text strong { font-size:12px; color:#ccc; line-height:1.4; }
...
@media(max-width:768px){
    ...
    .hero-info-item { border-right:none; border-bottom:1px solid rgba(255,255,255,0.07); }
...
<section class="section section-dark" id="booking">
    <div class="container">
        ...
        <div class="aos" style="margin-top:40px; border-radius:16px; overflow:hidden; box-shadow:0 8px 32px rgba(0,0,0,0.4);">
            <iframe
        ...
        <div style="text-align:center; margin-top:28px;" class="aos">
            <a href="book_table.php" class="btn-book" style="display:inline-flex; align-items:center; gap:8px; padding:14px 36px; font-size:15px;">
                🪑 Book Your Table
            </a>
